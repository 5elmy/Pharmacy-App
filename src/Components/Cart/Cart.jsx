                    ...
                    <tbody key={ind}>
                        <tr className='tr1'>
                            ...
                            <td  >
                                ...
                                <span  onClick={()=>{consumecount(ele.medicineId._id, ele.quantity+1) }} className=' d-flex justify-content-center align-items-center border border-1 p-3 div-size '> <i className="fa-duotone fa-plus fa-xl "></i></span>
                                <span className='  d-flex justify-content-center align-items-center border border-1  p-3'>{ele.quantity}</span>
                                <span onClick={()=>{consumecount(ele.medicineId._id, ele.quantity-1)}} className='  d-flex justify-content-center align-items-center  border border-1 p-3 div-size '> <i className=" fa-solid fa-minus"></i></span> 
                                </div>
